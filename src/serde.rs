/// Efficient JSON serialization, deserialization, and fast hashing utilities.
///
/// This module provides ergonomic wrappers around `serde_json` for JSON operations,
/// fast non-cryptographic hashing using ahash, and base64 encoding/decoding.
/// It includes utilities for common patterns like serialize-and-hash, async I/O,
/// and efficient JSON processing.
///
/// All functions are designed to be safe, performant, and easy to use in
/// production applications requiring data persistence and fast integrity checking.
